...
\hmey{As shown in the middle part of the figure, $T_1$ is processed...}
This leads to a makespan
of $w_0 + nk/2 + 1 + \epsilon$. The optimal solution, in turn, as shown in the bottom,
requires only $w_0 + n/2 + k$ timesteps. This means that \heftblc\ may yield solutions whose 
gap of optimality $\approx k$.
