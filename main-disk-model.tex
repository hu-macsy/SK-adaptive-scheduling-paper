...
All processors have access to a common disk space of unlimited size.
...
We can decide to evict some data from the individual memory onto the disk to free space in the individuaö memory.
    This data can be read back into memory at any time later.
