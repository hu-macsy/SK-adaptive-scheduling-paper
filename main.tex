...
%    TODO: Insert abstract
    ...
    An efficient execution of the workflows on such platforms requires to map the tasks
    to a particular processor; to increase utilization by reusing finished processors,
    ...
    \begin{itemize}
      ...
      \item Objective: makespan (proxy for total execution time)
