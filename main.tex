...
%    TODO: Insert abstract
    ...
    %%% CONTEXT %%%
    \begin{itemize}
      \item What is a scientific workflow?
      \item Scientific workflows are all over the place $\rightarrow$ important!
      \item Scheduling (order, maybe even concrete starting times) is important for efficient workflow executions
      \item Only mapping tasks to processors is not enough.
