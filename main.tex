...
%
    ...
    \begin{figure}[tb]
        ...
        \caption{Memory usage by algorithm by workflow size. Includes only valid heft schedules \skug{THIS FIGURE IS WRONG}}
    ...
    \begin{figure}[tb]
        \centering
        \includegraphics[width=1.1\columnwidth] {images/success-rates-large}
