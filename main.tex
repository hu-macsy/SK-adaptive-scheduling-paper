...
\AB{Any info on success rate of adaptive heuristic compared to static ones? 
For which cluster do we have some results? }
    ...
    In case of \heftmm, $16$ experiments ended with a successfully computed makespan without recomputation.
    Because \heftmm managed to schedule all experiments, the rate is $5.5\%$ success without recomputation out of all successful
    schedules with recomputation.
    $50$ experiments were successful in case of \heftblc ($35\%$ out of all successful schedules) and $55$ in case of
    \heftbl (roughly $50\%$ of all successful schedules).
