...
\new{the devations do not invalidate their scheduler. However, there is also nothing to be gained by rescheduling them.}
...
In case of \heftmm, all $290$\todo{SK: check!} workflows can be scheduled initially and all the schedules remain valid until the end,
...
\heftbl keeps $105$ schedules valid until the end out of $110$ initially valid schedules.
