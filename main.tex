...
To address this problem, we investigate in this paper the memory-aware scheduling of DAG-shaped workflows on
...
HEFT and its successors consist of two phases: task prio\-ri\-tization/ordering and task assignment.
...
In an assumed dual-memory system~\cite{herrmann2014memory},  a processor can have access 
