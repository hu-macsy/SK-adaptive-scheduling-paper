...
This advantage of \heftmm comes at the price of worse makespans than with \heftbl
...
if new tasks appear in (or disappear from) the workflow graph, or if there is variability in the platform, 
